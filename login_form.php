...
<head>
  ...
  .menu-list-c:hover .sub-menu4{display: block;}
   ...
   .login_id{width: 300px; height: 40px;}
   .login_pw{width: 300px; height: 40px; margin-top: 10px;}
   .login_sb{width: 305px; height: 40px; margin-top: 10px; background-color: black; color: white; border: none;}
   .login_sb:hover{text-decoration: none; animation: a 0.5s ease-in-out; -webkit-animation: a 0.5s ease-in-out; 
      color: #fff;}
      @-webkit-keyframes a {0%{color: #000}100%{color: #fff}}
      @keyframes a {0%{color: #000}100%{color: #fff}}
   .login_rg{width: 305px; height: 40px; background-color: black; color: white; border: none;}
   .login_rg:hover{text-decoration: none; animation: a 0.5s ease-in-out; -webkit-animation: a 0.5s ease-in-out; 
      color: #fff;}
      @-webkit-keyframes a {0%{color: #000}100%{color: #fff}}
      @keyframes a {0%{color: #000}100%{color: #fff}}
  ...
  <div class="top1">
    ...
    <div class="menu-list-c" ><a href="./qna.php"><b>고객센터</a></b>
        <div class="sub-menu4">
          ...
          <div><a href="./mtm.php">1대1 문의하기</a></div> 
        </div>
    </div>
...
<div class="menu-arrow">공지사항</div>

<div class = "wrap">
  <div class ="wrap2">
      <form method="POST" action="./login_result.php">
              <p align="center">L O G I N<p>
              <div class="login_box" align="center">
                  <input type="text" name = "uid" placeholder=" 아이디" class="login_id" /><br>
                  <input type="password" name="pwd"  placeholder=" 비밀번호" class="login_pw" /><br>
                  <input type ="submit" value="L O G I N" class="login_sb"><br><br>
                  <p align="center">아직 회원이 아니신가요?</p>
                  <input type ="button" value="J O I N U S" class="login_rg" onclick="location.href='./log_insert.php'">
              </div>
            </form>
  </div>
</div>
