...
<div class = "wrap">
	<div class ="wrap2">
		...
		<div class ="map1">
			<!-- * Daum 지도 - 지도퍼가기 -->
			<!-- 1. 지도 노드 -->
			<div id="daumRoughmapContainer1541320754109" class="root_daum_roughmap root_daum_roughmap_landing"></div>
		...
		<div class="st-info">
			<img src="./st-busan.jpg" width="430" height="340px">
			<p>매장명 : M'CR 부산점</p>
			<p>주소 : 부산광역시 부산진구 서면로 691층</p>
			<p>영업시간 : 09:00 ~ 20:00</p>
			<p>휴무는 지점마다 각각 다름</p> <br>
			<p>M'CR 부산점은 M'CR 오프라인 스토어 중 4번째로 오픈 한 곳입니다.</p>
			<p>서면역 7번출구와 가깝습니다.</p>
			<p>근처에 롯데백화점도 가깝습니다.</p>
		</div>
	</div>
</div>
<div class="copy">
