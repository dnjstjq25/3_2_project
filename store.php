...
<div class="menu-arrow">서울점</div>
<div class = "wrap">
	<div class ="wrap2">
		<!-- * Daum 지도 - 지도퍼가기 -->
		<!-- 1. 지도 노드 -->
		<div class ="map1">
			<div id="daumRoughmapContainer1541311468401" class="root_daum_roughmap root_daum_roughmap_landing">
				<!--
					2. 설치 스크립트
		...
		<div class="st-info">
			<img src="./st-seoul.jpg" width="430" height="340px">
			<p>매장명 : M'CR 서울점</p>
			<p>주소 : 서울 강남구 삼성동 159 1층</p>
			<p>영업시간 : 09:00 ~ 20:00</p>
			<p>휴무는 지점마다 각각 다름</p> <br>
			<p>M'CR 서울점은 M'CR 오프라인 스토어 중 가장 규모가 큰 곳입니다.</p>
			<p>봉은사역 7번 출구와 가깝습니다.</p>
			<p>M'CR 서울점 근처에 코엑스와 아쿠아리움이 가까워 다른 문화생활을<p>즐기기에도 좋은 위치에 있습니다.</p>
		</div>
	</div>
</div>
<div class="copy">
