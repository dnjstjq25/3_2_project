...
<body>
	<form name="borad_form" method="POST" action="./insert.php">
		<div id="write_form">
			...
			<div class="write_line"></div>
			<div id="write_button"><input type="image" src="./ok.png">&nbsp;<a href="./notice.php"><input type="image" src="./list.png"></a></div>
		</div>
	</form>
</body>
</html>