 ...
 <body>
 	<form  name="board_form" method="post" action="insert1.php?mode=modify&num=<?=$num?>"> 
	<div id="write_form">
	  ...
	  <div class="write_line"></div>
	   ...
	   <div id="write_button"><input type="image" src="./ok.png">&nbsp;
	     <a href="list1.php?page=<?=$page?>"><input type="image" src="./list.png"></a>
	   </div>
	 </form>
<?php
         }
