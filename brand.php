...
<head>
	...
	.menu-list-c:hover .sub-menu4{display: block;}
	 ...
	 .catalog{list-style: none; margin : 0 auto;}
	 .catalog li { margin: 20px 0px 0px 30px; float: left; position: relative; width: 290px; height: 290px; }
	 .catalog dl {border-radius: 10px 10px 10px 10px; }
	 ...
	 .copy_end {border-right: 1px solid #fff;}
	</style>
	<meta charset="utf-8">
	<title>M'CR</title>
</head>
...
<div class="menu-arrow"><a href="brand.php">브랜드</a></div>
<div class = "wrap">
	<div class ="wrap2">
		<ul class = "catalog">
				<li>
					<dl class="placeimg"><a href="./gucci.php"><img src="./gucci-logo.jpg" width="290px" height="290px"></a>
					</dl>
				</li>
				<li>
					<dl class="placeimg"><a href="./dior.php"><img src="./dior-logo.png" width="290px" height="290px"></a>
					</dl>
				</li>
				<li>
					<dl class="placeimg"><a href="./louis.php"><img src="./louis-logo.jpg" width="290px" height="290px"></a>
					</dl>
				</li>
			</ul>
			<ul class = "catalog">
				<li>
					<dl class="placeimg"><a href="./bbr.php"><img src="./bbr-logo.jpg" width="290px" height="290px"></a>
					</dl>
				</li>
				<li>
					<dl class="placeimg"><a href="./chan.php"><img src="./chan-logo.jpg" width="290px" height="290px"></a>
					</dl>
				</li>
				<li>
					<dl class="placeimg"><a href="./given.php"><img src="./given-logo.jpg" width="290px" height="290px"></a>
					</dl>
				</li>
			</ul>
			<ul class = "catalog">
				<li>
					<dl class="placeimg"><a href="./ck.php"><img src="./ck-logo.jpg" width="290px" height="290px"></a>
					</dl>
				</li>
				<li>
					<dl class="placeimg"><a href="./prada.php"><img src="./prada-logo.jpg" width="290px" height="290px"></a>
					</dl>
				</li>
			</ul>
	</div>
