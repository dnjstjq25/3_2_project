...
$query="insert into dnjstjq25.per_up(id, ctg, subject, price, file01, Tstory, regdate, ip)";
$query.="values('$id', '$ctg', '$subject', '$price', '$newfile01', '$Tstory', '$regdate', '$ip')";
