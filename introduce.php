...
<head>
	...
	.menu-list-c:hover .sub-menu4{display: block;}
	 ...
	 .wrap2{margin : 0 auto; width: 1080px; padding-top: 20px; height: 100%; }
	 ...
	 .int_img{margin-top: 18px; float: left; width: 500px;}
	 .int_con{float: right; width: 560px; font-family: menu-font; margin-top: 90px; font-size: 17px;}
	</style>
	<meta charset="utf-8">
	<title>M'CR</title>
</head>
...
<div class="menu-arrow">사이트 소개</div>
<div class = "wrap">
	<div class ="wrap2">
		<div class="int_img"><img src="./int_man.jpg" width="500px" height="600px"></div>
		<div class="int_con">
			<p>안녕하세요. <b>M'CR</b>입니다.</p>
			<p><b>M'CR</b> 온라인 스토어에 오신것을 환영합니다.</p>
			<p><b>M'CR</b>은 <b>Men's Correct</b>의 약자로 남자의 정답정도로 해석 할 수 있습니다.</p>
			<p><b>M'CR</b>은 각종 브랜드의 향수를 한곳에 모아서 유통하는 브랜드입니다.</p>
			<p>여러 브랜드를 이리저리 힘겹게 찾아가지 마시고 편하게 이용하시면 됩니다.</p>
			<p>온라인, 오프라인 매장 모두 <b>최상의</b> 제품만을 제공할 것을 약속 드립니다.</p>
			<p>온라인 매장의 경우 결제는 <b>무통장 입금만</b> 가능합니다.<p>이 점 유의하시길 바랍니다.</p>
			<p>남자를 남자답게 <p align="right">- M'CR -</p>
		</div>
	</div>
</div>
<div class="copy">
