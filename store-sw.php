...
<div class = "wrap">
	<div class ="wrap2">
		...
		<div class ="map1">
			<!-- * Daum 지도 - 지도퍼가기 -->
			<!-- 1. 지도 노드 -->
			<div id="daumRoughmapContainer1541319961800" class="root_daum_roughmap root_daum_roughmap_landing"></div>
		...
		<div class="st-info">
			<img src="./st-suwon.jpeg" width="430" height="340px">
			<p>매장명 : M'CR 수원점</p>
			<p>주소 : 경기도 수원시 팔달구 덕영대로 923-10 1층</p>
			<p>영업시간 : 09:00 ~ 20:00</p>
			<p>휴무는 지점마다 각각 다름</p> <br>
			<p>M'CR 수원점은 M'CR 오프라인 스토어 중 2번째로 오픈 한 곳입니다.</p>
			<p>수원역 10번 출구와 가깝습니다.</p>
			<p>수원역과 가까워 방문하시기 편하고 주변에 즐길거리도 많습니다.</p>
		</div>
	</div>
</div>
<div class="copy">
